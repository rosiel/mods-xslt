...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="mods:mods/mods:titleInfo[not(@type)]/mods:nonSort/text()"/>
    <xsl:template match="mods:mods/mods:titleInfo[not(@type)]/mods:title/text()"/>
    <xsl:template match="mods:mods/mods:titleInfo[not(@type)]/mods:subTitle/text()"/>
    <xsl:template match="mods:mods/mods:titleInfo[not(@type)]/mods:partNumber/text()"/>
    <xsl:template match="mods:mods/mods:titleInfo[not(@type)]/mods:partName/text()"/>
    
    <xsl:template match="mods:mods/mods:titleInfo[@type='alternative' or @type='uniform' or @type='abbreviated']/mods:nonSort/text()"/>
    <xsl:template match="mods:mods/mods:titleInfo[@type='alternative' or @type='uniform' or @type='abbreviated']/mods:title/text()"/>
    <xsl:template match="mods:mods/mods:titleInfo[@type='alternative' or @type='uniform' or @type='abbreviated']/mods:subTitle/text()"/>
    <xsl:template match="mods:mods/mods:titleInfo[@type='alternative' or @type='uniform' or @type='abbreviated']/mods:partNumber/text()"/>
    <xsl:template match="mods:mods/mods:titleInfo[@type='alternative' or @type='uniform' or @type='abbreviated']/mods:partName/text()"/>
    <xsl:template match="mods:mods/mods:titleInfo[@type='alternative' or @type='uniform' or @type='abbreviated']/@type"/>
    ...
    <xsl:template match="mods:mods/mods:subject/mods:name[count(mods:namePart)=1]/mods:namePart/text()"/>
    <xsl:template match="mods:mods/mods:subject/mods:name/mods:namePart[@type='given' or @type='family' or @type='date']/text()"/>
    <xsl:template match="mods:mods/mods:subject/mods:name/mods:namePart[@type='given' or @type='family' or @type='date']/@type"/>
    <xsl:template match="mods:mods/mods:subject/mods:geographic/text()"/>
    <xsl:template match="mods:mods/mods:subject/mods:hierarchicalGeographic/(mods:continent|mods:country|mods:province|mods:region|mods:state|mods:territory|mods:county|mods:city|mods:island|mods:area)/text()"/>
    ...
    <xsl:template match="mods:mods/mods:classification[@authority='lcc' or @authority='ddc']/@authority"/>
    
    
    <xsl:template match="mods:mods/mods:identifier/text()"/>
    <xsl:template match="mods:mods/mods:identifier[@authority='isbn' or @authority='oclc' or @authority='local']/@authority"/>
